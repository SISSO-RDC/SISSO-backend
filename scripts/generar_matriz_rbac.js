...
const CLASIFICACION_RECURSOS = {
  ...
  'reportes-peligro': 'operativo_individual (canal publico de reporte, reportante identificable solo si el mismo decide no ser anonimo)',
  'documentos-control': 'catalogo (documentos de gestion; acuses de lectura son operativo_individual)',
  'obligaciones-legales': 'catalogo',
  'auditorias': 'catalogo',
