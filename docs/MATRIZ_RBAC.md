...
| PUT | `/api/examenes-organizacion/:id/verificacion` | medico |
...
| GET | `/api/kpis-organizacion/comparativo` | cualquier rol autenticado (sin restriccion de rol) |
| PUT | `/api/kpis-organizacion/:id/vinculo` | admin |
