...
const areasOrganizacionRoutes = require('./routes/areasOrganizacionRoutes');
const riesgosOrganizacionRoutes = require('./routes/riesgosOrganizacionRoutes');
const examenesOrganizacionRoutes = require('./routes/examenesOrganizacionRoutes');
const herramientasErgonomicasOrganizacionRoutes = require('./routes/herramientasErgonomicasOrganizacionRoutes');
const kpisOrganizacionRoutes = require('./routes/kpisOrganizacionRoutes');
const organizacionRoutes = require('./routes/organizacionRoutes');
const catalogoSectoresRoutes = require('./routes/catalogoSectoresRoutes');
const configuracionSectorialRoutes = require('./routes/configuracionSectorialRoutes');
const catalogoPaisesRoutes = require('./routes/catalogoPaisesRoutes');
...
app.use('/api/areas-organizacion', areasOrganizacionRoutes);
app.use('/api/riesgos-organizacion', riesgosOrganizacionRoutes);
app.use('/api/examenes-organizacion', examenesOrganizacionRoutes);
app.use('/api/herramientas-ergonomicas-organizacion', herramientasErgonomicasOrganizacionRoutes);
app.use('/api/kpis-organizacion', kpisOrganizacionRoutes);
app.use('/api/organizacion', organizacionRoutes);
app.use('/api/catalogo-sectores', catalogoSectoresRoutes);
app.use('/api/configuracion-sectorial', configuracionSectorialRoutes);
app.use('/api/catalogo-paises', catalogoPaisesRoutes);
