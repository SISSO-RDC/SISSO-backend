  ...
  try {
    ...
    const filaInsertada = await client.query(
      `INSERT INTO examenes_espirometria (
        ...
        fvc_predicho, fev1_predicho, pef_predicho, fef2575_predicho, fev1_fvc_predicho,
        fvc_lln, fev1_lln,
        fvc_pct_predicho, fev1_pct_predicho, pef_pct_predicho, fef2575_pct_predicho, fev1_fvc_medido,
        patron,
        reversibilidad_positiva, cambio_fev1_pct, cambio_fev1_ml, cambio_fvc_pct, cambio_fvc_ml,
        observaciones
      ) VALUES (
        $1,$2,$3,$4,
        $5,$6,$7,$8,
        ...
        $36
                  ...
                  reversibilidad_positiva, cambio_fev1_pct`,
      [
        ...
        resultado.fvcPredicho, resultado.fev1Predicho, resultado.pefPredicho, resultado.fef2575Predicho, resultado.fev1FvcPredicho,
        ...
        resultado.patron,
        resultado.reversibilidad.esPositiva, resultado.reversibilidad.cambioPct, resultado.reversibilidad.cambioMl,
        resultado.reversibilidad.cambioPctFvc ?? null, resultado.reversibilidad.cambioMlFvc ?? null,
  ...
  try {
    ...
    const res2 = await query(
      `SELECT e.id, e.fecha_examen, e.fvc_pre, e.fev1_pre, e.fev1_fvc_medido,
              ...
              e.reversibilidad_positiva, e.cambio_fev1_pct,
